...
function debugDetails(logId, timeStamp, errorType, error) {
    if(SETTINGS["DEBUG"]){
        // function for debugging details and creating a JSON object for logging
        var debugInfo = {
            LogID: logId,
            Timestamp: timeStamp,
            ErrorType: errorType,
...
try { 
    ...
    try { 
        throw new Error("This is an error message"); // this will throw an error to simulate an error for error handling
    }catch (e) {
