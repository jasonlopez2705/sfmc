...
FROM TEST_SVI_ENTRY_IMPORT_DE /(* FROM THE FINAL TEST SVI ENTRY IMPORT DE TABLE */)
WHERE 
    ...
    AND (
    /* FOR THIS JOURNEY, THE TASK STATUS CODE SHOULD BE  NW(NOT WORKED) OR IP(IN PROGRESS) */
        SEPVRFTASKSTATUS = 'NW' 
        OR SEPVRFTASKSTATUS = 'IP'
    )
